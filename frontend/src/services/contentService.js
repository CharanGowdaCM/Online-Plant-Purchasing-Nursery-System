...
// Features: contentService, api, blogPosts, plantGuides, createBlogPost, updateBlogPost, 
// deleteBlogPost, listBlogPosts, createPlantGuide, updatePlantGuide, deletePlantGuide, 
// listPlantGuides, async, RESTful API, admin content management, user content, 
...
const contentService = {
  ...
  listBlogPostsUser: async (params = {}) => {
    try {
      const response = await api.get('/users/blog', { params });
      return response.data;
    } catch (error) {
      console.error('Error fetching blog posts:', error);
      throw error;
  ...
  listPlantGuides: async (params = {}) => {
   ...
   listPlantGuidesUser: async (params = {}) => {
    try {
      const response = await api.get('/users/plant-guides', { params });
      return response.data;
    } catch (error) {
      console.error('Error fetching plant guides:', error);
      throw error;
