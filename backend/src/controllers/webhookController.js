/*
 Payment Helper Controller - handles payment gateway webhooks and updates order status accordingly
 Author: M Lakshya
 Features: Razorpay webhook handling for payment success, failure, refunds, and order payments
*/
