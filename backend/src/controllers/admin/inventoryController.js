/*
 Inventory Controller - Handles inventory management 
 Author:Charan Gowda C M
 Features: Get inventory status, Update stock, Product and Category management
*/
...
class InventoryController {
  ...
  static async updateStock(req, res) {
    try {
      ...
      recordActivity(req, 'UPDATE', 'Inventory', productId, {
        quantity,
        operation,
        notes
      });
  ...
  static async addProduct(req, res) {
    try {
      ...
      recordActivity(req, 'CREATE', 'Product', product.id, {
        sku: product.sku,
        name: product.name,
  ...
  static async getProductById(req, res) {
    try {
      ...
      return res.status(500).json({
        success: false,
        message: err.message || 'Server error while fetching product details',
      });
    }
  }
  ...
  static async editProduct(req, res) {
    try {
      ...
      recordActivity(req, 'UPDATE', 'Product', productId, {
  ...
  static async addCategory(req, res) {
    try {
      ...
      recordActivity(req, 'CREATE', 'Category', category.id, {
        name: category.name,
